    ...
    const res = await axios.post(
      "https://api.instantly.ai/api/v1/lead/add",
      {
        ...
        leads: [{
          ...
          personalization: buildPersonalization(data),
...
function buildPersonalization(data) {
  const page = data.pagesVisited || "our site";
  return `Saw you visited our ${page} page — wanted to reach out directly.`;
}
